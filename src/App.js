...
class BooksApp extends Component {
  ...
  changeShelve(book, targetShelf){
    // var booksClone =self.state.booksArray
    // var bookIndex = booksClone.findIndex( cbook => cbook.id == book.id);
    // booksClone[bookIndex].shelf =targetShelf
    
    // self.setState((state) =>({
    //   booksArray : booksClone
    // }))
